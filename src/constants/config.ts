export const CONFIG = {
  ...
  wordListSource: 'Corpuses collected by Raphael A. Finkel, Simche Taub and alephreish.', // Describe the source material for your words here
  ...
  availableLangs: ['en', 'yi', 'he'], // the options available to the user for translation languages
}
